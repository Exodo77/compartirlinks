      ...
      <main className="w-full max-w-md z-10">
        <div className="glass-card rounded-2xl p-8 space-y-8 relative overflow-hidden">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-zinc-400 text-sm">Empieza a guardar tus enlaces al instante</p>
          </div>
          ...
          <form action={formAction} className="space-y-5">
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900/50 border border-zinc-800 rounded-xl px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all mb-1"
                  placeholder="Ej. waltter_nuevo"
                />
                <p className="text-xs text-zinc-500">Este será tu alias público y debe tener al menos 3 caracteres.</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="••••••••"
                />
                <p className="text-xs text-zinc-500">Mínimo 6 caracteres para mantener tus links seguros.</p>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full bg-white text-zinc-900 hover:bg-zinc-100 disabled:opacity-70 disabled:cursor-not-allowed font-medium rounded-xl px-4 py-3 transition-all flex items-center justify-center gap-2 group mt-2"
            >
              {isPending ? (
          ...
          <div className="mt-6 flex flex-col items-center">
             <a href="/login" className="text-sm font-medium text-zinc-500 hover:text-emerald-400 transition-colors">
